...
**Difficulty:** Easy — `27_remove_element.py`

Given an integer array `nums` and an integer `val`, remove all occurrences of
`val` in `nums` [in-place](https://en.wikipedia.org/wiki/In-place_algorithm).
...
**Difficulty:** Easy — `104_maximum_depth_of_binary_tree.py`
